...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.doGet = function (path, params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(doGetRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.doPost = function (path, params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(doPostRequest, authType, additionalParams, config.apiKey);
    };
